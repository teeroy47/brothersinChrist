...
export const levels: Level[] = [
  {
    ...
    description:
      "Foundations in prayer, Scripture, brotherhood, and personal surrender to Christ.",
    requirements: [
  ...
  },
  {
    ...
    description:
      "Growing into consistency, Scripture understanding, and disciplined living.",
    requirements: [
      "Maintain attendance",
      "Serve in one ministry area",
      "Complete Rooted teaching track",
    ],
    expectations: [
  ...
  },
  {
    ...
    description:
      "Stable discipleship marked by reliability, inner strength, and reproducible habits.",
    requirements: [
      "Disciple one younger brother",
      "Serve monthly",
      "Complete steady growth review",
    ],
    expectations: [
      "Keep prayer journal",
      "Follow through on group commitments",
      "Model faithfulness",
    ],
  ...
  },
  {
    ...
    description:
      "Men who serve, influence, and help carry the culture of the brotherhood.",
    requirements: [
      "Lead a prayer moment",
      "Track follow-up for others",
      "Complete serving module",
    ],
    expectations: [
      "Model discipline",
      "Build unity",
  ...
  },
  {
    ...
    description:
      "Men entrusted with forming other men through oversight, prayer, and wise leadership.",
    requirements: [
      "Oversee a group or level",
      "Submit leader reports",
...
export const users: User[] = [
  {
    ...
    consistencyScore: 82,
    recentActivity:
      "Completed last week's check-in and attended Thursday prayer.",
    profile: {
      ...
      testimony:
        "Learning to live with daily discipline and Scripture-led decisions.",
      spiritualGoals: [
        "Build stronger prayer rhythm",
        "Memorise Scripture weekly",
      ],
  ...
  },
  {
    ...
    consistencyScore: 91,
    recentActivity:
      "Posted a group encouragement and reviewed struggling members.",
    profile: {
  ...
  },
  {
    ...
    consistencyScore: 95,
    recentActivity:
      "Reviewed analytics and posted the monthly leadership brief.",
    profile: {
  ...
  },
  {
    ...
    consistencyScore: 74,
    recentActivity:
      "Missed the Monday meeting but connected with his accountability partner.",
    profile: {
...
export const groups: Group[] = [
  {
    ...
    summary:
      "A close discipleship group focused on consistency, Scripture, and honest accountability.",
    prayerRequests: [
      "Strength for one brother facing job instability",
      "Healing for a family member",
    ],
    encouragements: [
      "Stay faithful in the small disciplines.",
      "Grace and truth can shape strong men.",
    ],
    createdAt: now,
    updatedAt: now,
    status: "active",
  },
  {
    ...
    summary:
      "Men being rooted in doctrine, prayer, and disciplined leadership at home and work.",
...
export const posts: Post[] = [
  {
    ...
    excerpt:
      "The hidden disciplines of prayer and Scripture form public strength.",
  ...
  },
  {
    ...
    excerpt:
      "A level-specific teaching on building conviction through daily Scripture.",
  ...
  },
  {
    ...
    excerpt:
      "All brothers are expected to attend the next all-night prayer gathering.",
...
export const standardHabits: DailyHabitItem[] = [
  // GOD: Prayer & Scripture
  {
    id: "h-god-prayer",
    pillar: "god",
    title: "Morning Prayer",
    description: "15+ mins dedicated uninterrupted prayer",
  },
  {
    id: "h-god-word",
    pillar: "god",
    title: "Scripture Intake",
    description: "Read daily chapter or devotion",
  },

  // MIND: Truth, Wisdom & Finances
  {
    id: "h-mind-wisdom",
    pillar: "mind",
    title: "Wisdom & Finances",
    description: "Kingdom stewardship reading or financial review",
  },

  // BODY: Gym & Physical Discipline
  {
    id: "h-body-gym",
    pillar: "body",
    title: "Gym & Physical Discipline",
    description: "Workout, running, or fasting discipline",
  },

  // LIFE: Character, Responsibility & Fruit
  {
    id: "h-life-character",
    pillar: "life",
    title: "Character & Fruit",
    description: "Integrity check, patience, and honoring commitments",
  },
];

export const checkInTemplate: CheckInTemplate = {
  id: "template-1",
  title: "Weekly Discipleship & Pillar Check-In",
  audience: "all",
  questions: [
    {
      id: "god_prayer_word",
      prompt:
        "GOD: Did you maintain consistent morning prayer & Scripture intake this week?",
      type: "boolean",
    },
    {
      id: "mind_wisdom",
      prompt:
        "MIND: Did you feed on truth and practice wise financial stewardship?",
      type: "boolean",
    },
    {
      id: "body_discipline",
      prompt:
        "BODY: Did you keep your physical discipline (gym, training, nutrition/fast)?",
      type: "boolean",
    },
    {
      id: "life_character",
      prompt:
        "LIFE: Did you walk with integrity, patience, and honor in your daily responsibilities?",
      type: "boolean",
    },
    {
      id: "brother_sync",
      prompt:
        "ACCOUNTABILITY: Did you connect with your accountability partner this week?",
      type: "boolean",
    },
    {
      id: "struggles",
      prompt: "Where did you face friction, temptation, or weakness this week?",
      type: "text",
    },
    {
      id: "prayer_need",
      prompt: "Specific prayer request for your group leader and brothers:",
      type: "text",
    },
  ],
  createdAt: now,
...
export const leaderReports: LeaderReport[] = [
  {
    ...
    summary:
      "Attendance was steady overall, but one younger brother is drifting and needs direct contact.",
...
export function getSessionOptions(): Array<
  SessionUser & { description: string }
> {
  return [
    {
      id: "u-1",
    ...
    },
    {
      ...
      name: "Simba Ndlovu",
      role: "group_leader",
      description: "Group leader workflow",
    },
    {
      id: "u-3",
      name: "Bongani Dube",
      role: "level_leader",
      description: "Level leader workflow",
    },
    {
      id: "u-4",
      name: "Pastor Tendai Chirwa",
      role: "admin",
      description: "Admin oversight",
    },
  ];
}
export function getAccountabilityPartner(userId: string): User | undefined {
  const user = getUserById(userId);
  if (!user || !user.accountabilityPartnerId) return undefined;
  return getUserById(user.accountabilityPartnerId);
}
